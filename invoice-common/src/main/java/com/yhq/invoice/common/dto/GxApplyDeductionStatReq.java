...
/**
 * 抵扣勾选请求：申请抵扣统计（SQCXDKTJ）。
 * 字段依据《乐企增值税抵扣勾选能力说明文档-V3.025》接口 6「申请抵扣统计」补全。
 */
@Getter
@Setter
@NoArgsConstructor
public class GxApplyDeductionStatReq extends GxRequest {

    public GxApplyDeductionStatReq(CapabilityCode capabilityCode) {
