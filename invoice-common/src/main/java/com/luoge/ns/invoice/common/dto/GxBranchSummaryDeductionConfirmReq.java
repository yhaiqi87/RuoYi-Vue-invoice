...
/**
 * 抵扣勾选请求：总分机构汇总勾选确认（ZFJGHZGXQR）。
 * 字段依据《乐企增值税抵扣勾选能力说明文档-V3.025》接口 23「总分机构汇总勾选确认」补全。
 */
@Getter
@Setter
@NoArgsConstructor
public class GxBranchSummaryDeductionConfirmReq extends GxRequest {

    public GxBranchSummaryDeductionConfirmReq(CapabilityCode capabilityCode) {
