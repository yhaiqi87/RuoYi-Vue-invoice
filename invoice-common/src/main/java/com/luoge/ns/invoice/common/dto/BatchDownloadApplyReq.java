...
/**
 * 乐企请求：BatchDownloadApply。字段依据乐企开票能力说明文档补全。
 */
@Getter
@Setter
@NoArgsConstructor
public class BatchDownloadApplyReq extends InvoiceRequest {

    public BatchDownloadApplyReq(CapabilityCode capabilityCode) {
